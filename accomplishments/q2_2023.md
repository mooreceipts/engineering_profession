...
2. Mentorship and Knowledge Sharing:
     ...
     - Continued to administer/curate RaaS Making-A-Developer (https://go/sdimad) program for onboarding new team members and/or non-team members looking to upskill in the primary languages/concepts/technologies we deal in.
     ...
     - Authored and published (internally to USAA) technical documentation, knowledge/sample reference libraries, and industry/role applicable book notes/reviews.

          - https://prodgitlab.usaa.com/nw85887/engineering-profession
